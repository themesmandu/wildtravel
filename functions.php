...
function wildtravel_scripts() {
	...
	wp_enqueue_style( 'wptravel-css', get_theme_file_uri( '/assets/css/wptravel.css' ), array( 'wildtravel-style' ), wp_get_theme()->get( 'Version' ) );
	...
	wp_enqueue_script( 'wildtravel-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'wildtravel-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
